...
All upstream runtime files are copied byte-for-byte into this directory.
...
The source snapshot includes no standalone license. Existing branding and
embedded notices are preserved; FCB claims no ownership of upstream work.
